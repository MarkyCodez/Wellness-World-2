      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <Tabs defaultValue="activity" className="space-y-6 sm:space-y-8">
          ...
          <TabsContent value="activity" className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="bg-gradient-to-br from-rose-500 via-rose-400 to-orange-400 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl shadow-rose-200/50 dark:shadow-none relative overflow-hidden">
              ...
              <div className="relative z-10 max-w-2xl">
                ...
                <h2 className="text-4xl md:text-5xl font-black mb-6 leading-tight">You're building great momentum!</h2>
                <CoachingMessage 
                ...
                <div className="mt-10 flex flex-wrap gap-4">
                  ...
                  <Button 
                    ...
                    variant="secondary" 
                    className="bg-white/20 hover:bg-white/30 border-none text-white rounded-xl font-bold backdrop-blur-md px-8 py-6"
                  >
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] shadow-sm border border-slate-100 dark:border-slate-800">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-bold text-slate-800 dark:text-slate-100">Your Focus Areas</h3>
                  </div>
                  <div className="space-y-3">
                    {profile?.goals?.map((goal: string) => (
                      <div key={goal} className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100/50 dark:border-slate-700/50 transition-colors hover:bg-rose-50/30 dark:hover:bg-rose-900/10">
                        <div className="w-2 h-2 rounded-full bg-rose-400" />
                        <span className="text-sm font-bold text-slate-600 dark:text-slate-300">{goal}</span>
                      </div>
                    ))}
                  </div>
                </div>
